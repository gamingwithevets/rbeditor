...
''',
	...
	'vi_VN': {
		...
		'msgbox_lnk_warn': '''\
Tệp bạn vừa mở là tệp shortcut (.lnk).

Nếu tệp hoặc thư mục mà shortcut này liên kết đến không còn tồn tại, Windows sẽ hiển thị lời nhắc hỏi bạn có muốn xóa shortcut hay không.
Nếu bạn chọn Có, shortcut sẽ bị XÓA VĨNH VIỄN khỏi Thùng rác.

Nếu bạn đã vô tình mở shortcut, không cần phải lo lắng, chỉ cần nhấn Không.

Bạn có muốn tiếp tục không?\
''',
		'msgbox_restore': 'Khôi phục mục này?',
		'msgbox_restore_desc': 'Bạn có muốn khôi phục mục này về vị trí ban đầu không?',
		'msgbox_delete': 'Xóa mục này?',
		'msgbox_delete_desc': 'Bạn có chắc chắn muốn xóa vĩnh viễn mục này không?\nBẠN KHÔNG THỂ HOÀN TÁC THAO TÁC NÀY!',

		'oglocation': 'Vị trí ban đầu',
		'type': 'Loại',
		'size': 'Kích thước',
