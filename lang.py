...
''',
		...
		'msgbox_no_sid': 'You are using RBEditor with a user account with no associated SID in WMI/CIM data (e.g. the SYSTEM account).',
...
''',
		...
		'msgbox_no_sid': 'Bạn đang sử dụng RBEditor với tài khoản người dùng không có SID được liên kết trong dữ liệu WMI/CIM (VD: tài khoản SYSTEM).',
...
''',
		...
		'msgbox_warning': '警告',
		'msgbox_notice': '知らせ',
		'msgbox_no_sid': 'WMI/CIM データに SID のないユーザー アカウント (SYSTEM アカウントなど) で RBEditor を使用しています。',
